/*
 * modify by ernest 2016-01-29
 * fix let window.getComputedStyle ignore ie8
 * declare a arg named xStyle
 */
      ...
      offsetParent: function(elem) {
        ...
        function isStaticPositioned(el) {
          ...
          if ($window.getComputedStyle) {
        	  xStyle = $window.getComputedStyle(el);
          }
          return (xStyle.position || 'static') === 'static';
        }
